...
public class MockFailedServiceEpisodeList implements ServiceEpisodeListNo {

    private final BehaviorDelegate<ServiceEpisodeListNo> delegate;

    public MockFailedServiceEpisodeList(BehaviorDelegate<ServiceEpisodeListNo> service) {
